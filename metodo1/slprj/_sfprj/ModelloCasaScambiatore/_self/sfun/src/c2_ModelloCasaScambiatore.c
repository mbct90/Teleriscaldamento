...
static const char * c2_debug_family_names[11] = { "ti_temp", "err1", "m1",
  "pos1", "nargin", "nargout", "Km", "Tamb", "Gu", "tu", "ti" };

/* Function Declarations */
static void initialize_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static void initialize_params_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static void enable_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static void disable_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static void set_sim_state_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static void sf_gateway_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static void mdl_start_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static void c2_chartstep_c2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static void initSimStructsc2_ModelloCasaScambiatore
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void
  *c2_b_inData);
static real_T c2_emlrt_marshallIn(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance, const mxArray *c2_b_ti, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_b_inData);
static void c2_c_emlrt_marshallIn(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[68001]);
...
static void c2_eml_switch_helper(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance);
static void c2_power(SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance,
                     real_T c2_a[68001], real_T c2_b_y[68001]);
static void c2_eml_error(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance);
static void c2_abs(SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance,
                   real_T c2_x[68001], real_T c2_b_y[68001]);
static void c2_eml_extremum(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance, real_T c2_x[68001], real_T *c2_extremum, int32_T *c2_indx);
static void c2_check_forloop_overflow_error
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance, boolean_T
   c2_overflow);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_b_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_ModelloCasaScambiatore, const
  char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance);
  ...
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_ModelloCasaScambiatore = 0U;
}
  ...
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = *chartInstance->c2_ti;
  c2_b_u = c2_hoistedGlobal;
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 0, c2_c_y);
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_ModelloCasaScambiatore;
   ...
   *c2_st)
{
  ...
  *chartInstance->c2_ti = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_b_u, 0)), "ti");
  chartInstance->c2_is_active_c2_ModelloCasaScambiatore = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_b_u, 1)),
     "is_active_c2_ModelloCasaScambiatore");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_ModelloCasaScambiatore(chartInstance);
  ...
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Km, 0U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_ModelloCasaScambiatore(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_ModelloCasaScambiatoreMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_ti, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Tamb, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Gu, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_tu, 4U);
}
  ...
  (SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = *chartInstance->c2_Km;
  c2_b_hoistedGlobal = *chartInstance->c2_Tamb;
  c2_c_hoistedGlobal = *chartInstance->c2_Gu;
  c2_d_hoistedGlobal = *chartInstance->c2_tu;
  c2_b_Km = c2_hoistedGlobal;
  c2_b_Tamb = c2_b_hoistedGlobal;
  c2_b_Gu = c2_c_hoistedGlobal;
  c2_b_tu = c2_d_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 11U, 11U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(chartInstance->c2_ti_temp, 0U,
    c2_b_sf_marshallOut, c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(chartInstance->c2_err1, 1U,
    c2_b_sf_marshallOut, c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_m1, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_pos1, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 5U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_Km, 6U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_Tamb, 7U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_Gu, 8U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_tu, 9U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_ti, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 4);
  chartInstance->c2_ti_temp[0] = 10.0;
  chartInstance->c2_ti_temp[68000] = 78.0;
  c2_eml_switch_helper(chartInstance);
  for (c2_k = 1; c2_k < 34000; c2_k++) {
    c2_b_k = c2_k;
    c2_kd = (real_T)c2_b_k * 0.001;
    c2_a = c2_b_k;
    c2_b_a = c2_a + 1;
    c2_c = c2_b_a;
    chartInstance->c2_ti_temp[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c2_c), 1, 68001, 1, 0) - 1] = 10.0 + c2_kd;
    c2_b_b = c2_b_k;
    c2_c_b = c2_b_b;
    c2_b_c = 68001 - c2_c_b;
    chartInstance->c2_ti_temp[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c2_b_c), 1, 68001, 1, 0) - 1] = 78.0 -
      c2_kd;
  }

  chartInstance->c2_ti_temp[34000] = 44.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 5);
  for (c2_i0 = 0; c2_i0 < 68001; c2_i0++) {
    chartInstance->c2_A[c2_i0] = c2_b_tu + chartInstance->c2_ti_temp[c2_i0];
  }

  for (c2_i1 = 0; c2_i1 < 68001; c2_i1++) {
    chartInstance->c2_A[c2_i1] /= 2.0;
  }

  c2_c_a = c2_b_Km;
  for (c2_i2 = 0; c2_i2 < 68001; c2_i2++) {
    chartInstance->c2_b_A[c2_i2] = chartInstance->c2_A[c2_i2] - c2_b_Tamb;
  }

  c2_power(chartInstance, chartInstance->c2_b_A, chartInstance->c2_A);
  for (c2_i3 = 0; c2_i3 < 68001; c2_i3++) {
    chartInstance->c2_A[c2_i3] *= c2_c_a;
  }

  c2_d_a = c2_b_Gu;
  for (c2_i4 = 0; c2_i4 < 68001; c2_i4++) {
    chartInstance->c2_b[c2_i4] = c2_b_tu - chartInstance->c2_ti_temp[c2_i4];
  }

  for (c2_i5 = 0; c2_i5 < 68001; c2_i5++) {
    chartInstance->c2_b[c2_i5] *= c2_d_a;
  }

  for (c2_i6 = 0; c2_i6 < 68001; c2_i6++) {
    chartInstance->c2_err1[c2_i6] = chartInstance->c2_A[c2_i6] -
      chartInstance->c2_b[c2_i6];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 6);
  for (c2_i7 = 0; c2_i7 < 68001; c2_i7++) {
    chartInstance->c2_b_err1[c2_i7] = chartInstance->c2_err1[c2_i7];
  }

  c2_abs(chartInstance, chartInstance->c2_b_err1, chartInstance->c2_A);
  for (c2_i8 = 0; c2_i8 < 68001; c2_i8++) {
    chartInstance->c2_c_A[c2_i8] = chartInstance->c2_A[c2_i8];
  }

  c2_eml_extremum(chartInstance, chartInstance->c2_c_A, &c2_extremum, &c2_iindx);
  ...
  c2_b_ti = chartInstance->c2_ti_temp[_SFD_EML_ARRAY_BOUNDS_CHECK("ti_temp",
    (int32_T)_SFD_INTEGER_CHECK("pos1", c2_pos1), 1, 68001, 1, 0) - 1];
  sf_mex_printf("%s =\\n", "ti");
  c2_b_u = c2_b_ti;
  c2_b_y = NULL;
  ...
  *c2_b_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance;
  chartInstance = (SFc2_ModelloCasaScambiatoreInstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  c2_b_u = *(real_T *)c2_b_inData;
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", &c2_b_u, 0, 0U, 0U, 0U, 0), false);
  ...
  *chartInstance, const mxArray *c2_b_ti, const char_T *c2_identifier)
{
  ...
  c2_b_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_ti), &c2_thisId);
  sf_mex_destroy(&c2_b_ti);
  return c2_b_y;
}
...
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_b_ti;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_b_y;
  SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance;
  chartInstance = (SFc2_ModelloCasaScambiatoreInstanceStruct *)chartInstanceVoid;
  c2_b_ti = sf_mex_dup(c2_mxArrayInData);
  ...
  *c2_b_inData)
{
  ...
  chartInstance = (SFc2_ModelloCasaScambiatoreInstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i9 = 0; c2_i9 < 68001; c2_i9++) {
    chartInstance->c2_inData[c2_i9] = (*(real_T (*)[68001])c2_b_inData)[c2_i9];
  }

  for (c2_i10 = 0; c2_i10 < 68001; c2_i10++) {
    chartInstance->c2_u[c2_i10] = chartInstance->c2_inData[c2_i10];
  }
...
{
  int32_T c2_i11;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_b_u), chartInstance->c2_dv0, 1, 0, 0U,
                1, 0U, 2, 1, 68001);
  for (c2_i11 = 0; c2_i11 < 68001; c2_i11++) {
    c2_b_y[c2_i11] = chartInstance->c2_dv0[c2_i11];
  }
...
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_c_err1;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  int32_T c2_i12;
  SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance;
  chartInstance = (SFc2_ModelloCasaScambiatoreInstanceStruct *)chartInstanceVoid;
  c2_c_err1 = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_c_err1), &c2_thisId,
                        chartInstance->c2_y);
  sf_mex_destroy(&c2_c_err1);
  for (c2_i12 = 0; c2_i12 < 68001; c2_i12++) {
    (*(real_T (*)[68001])c2_outData)[c2_i12] = chartInstance->c2_y[c2_i12];
  }

  sf_mex_destroy(&c2_mxArrayInData);
}

const mxArray *sf_c2_ModelloCasaScambiatore_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  c2_nameCaptureInfo = NULL;
  sf_mex_assign(&c2_nameCaptureInfo, sf_mex_createstruct("structure", 2, 79, 1),
                false);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("colon"), "name", "name", 0);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!is_flint_colon"),
                  "context", "context", 2);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isfinite"), "name", "name", 2);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 2);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 6);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isnan"), "name", "name", 6);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 11);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("realmax"), "name", "name", 11);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!float_colon_length"),
                  "context", "context", 15);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isinf"), "name", "name", 15);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 15);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!float_colon_length"),
                  "context", "context", 20);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eps"), "name", "name", 20);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 22);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_eps"), "name", "name", 22);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_rdivide.m"),
                  "context", "context", 36);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("coder.internal.indexDivide"),
                  "name", "name", 36);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 50);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("rdivide"), "name", "name", 50);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 50);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 53);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_div"), "name", "name", 53);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 53);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
...
static void c2_b_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(""), "context", "context", 64);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 66);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 66);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, sf_mex_duplicatearraysafe(&c2_lhs66), "lhs", "lhs",
                  66);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(""), "context", "context", 67);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_const_nonsingleton_dim.m"),
                  "context", "context", 70);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "coder.internal.constNonSingletonDim"), "name", "name", 70);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 70);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m!eml_extremum_sub"),
                  "context", "context", 74);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isnan"), "name", "name", 74);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 74);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
                     ...
                     real_T c2_a[68001], real_T c2_b_y[68001])
{
  ...
  for (c2_k = 0; c2_k < 68001; c2_k++) {
    ...
    c2_b_a = c2_ak;
    c2_ar = c2_b_a;
    c2_c_y = muDoubleScalarPower(c2_ar, 1.32);
    c2_b_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      c2_b_k), 1, 68001, 1, 0) - 1] = c2_c_y;
  }
}
  ...
  *chartInstance)
{
  ...
  const mxArray *c2_b_y = NULL;
  (void)chartInstance;
  for (c2_i13 = 0; c2_i13 < 31; c2_i13++) {
    c2_b_u[c2_i13] = c2_cv0[c2_i13];
  }
  ...
  *chartInstance, real_T c2_x[68001], real_T *c2_extremum, int32_T *c2_indx)
{
  ...
  if (c2_ixstart < 68001) {
    ...
    for (c2_c_ix = c2_i14; c2_c_ix < 68002; c2_c_ix++) {
      c2_b_ix = c2_c_ix;
  ...
  char_T *c2_identifier)
{
  ...
  c2_b_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_ModelloCasaScambiatore), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_ModelloCasaScambiatore);
  return c2_b_y;
}
...
static void init_simulink_io_address(SFc2_ModelloCasaScambiatoreInstanceStruct
  *chartInstance)
{
  chartInstance->c2_Km = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    0);
  chartInstance->c2_ti = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_Tamb = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_Gu = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    2);
  chartInstance->c2_tu = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    3);
}
...
void sf_c2_ModelloCasaScambiatore_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1556301240U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(870155363U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3046539357U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3503129340U);
}

mxArray* sf_c2_ModelloCasaScambiatore_get_post_codegen_info(void);
mxArray *sf_c2_ModelloCasaScambiatore_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("oXKauJBVztfOg8b0S2bIjF");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_ModelloCasaScambiatore_get_post_codegen_info();
...
mxArray *sf_c2_ModelloCasaScambiatore_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_ModelloCasaScambiatore_jit_fallback_info(void)
{
...
mxArray *sf_c2_ModelloCasaScambiatore_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_ModelloCasaScambiatore(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"ti\",},{M[8],M[0],T\"is_active_c2_ModelloCasaScambiatore\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_ModelloCasaScambiatore_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_ModelloCasaScambiatoreInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _ModelloCasaScambiatoreMachineNumber_,
           2,
           1,
           1,
           0,
        ...
        init_script_number_translation(_ModelloCasaScambiatoreMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_ModelloCasaScambiatoreMachineNumber_,
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"Km");
          _SFD_SET_DATA_PROPS(1,2,0,1,"ti");
          _SFD_SET_DATA_PROPS(2,1,1,0,"Tamb");
          _SFD_SET_DATA_PROPS(3,1,1,0,"Gu");
          _SFD_SET_DATA_PROPS(4,1,1,0,"tu");
        ...
        _SFD_SET_DATA_COMPILED_PROPS(4,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c2_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c2_Km);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c2_ti);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c2_Tamb);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c2_Gu);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c2_tu);
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _ModelloCasaScambiatoreMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "Nn2Q49ev59ZyMvXXBs5DgF";
}

static void sf_opaque_initialize_c2_ModelloCasaScambiatore(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_ModelloCasaScambiatoreInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_ModelloCasaScambiatore
    ((SFc2_ModelloCasaScambiatoreInstanceStruct*) chartInstanceVar);
  initialize_c2_ModelloCasaScambiatore
    ((SFc2_ModelloCasaScambiatoreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_ModelloCasaScambiatore(void *chartInstanceVar)
{
  enable_c2_ModelloCasaScambiatore((SFc2_ModelloCasaScambiatoreInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_ModelloCasaScambiatore(void *chartInstanceVar)
{
  disable_c2_ModelloCasaScambiatore((SFc2_ModelloCasaScambiatoreInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_ModelloCasaScambiatore(void *chartInstanceVar)
{
  sf_gateway_c2_ModelloCasaScambiatore
    ((SFc2_ModelloCasaScambiatoreInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_ModelloCasaScambiatore
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_ModelloCasaScambiatore
    ((SFc2_ModelloCasaScambiatoreInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_ModelloCasaScambiatore(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_ModelloCasaScambiatore
    ((SFc2_ModelloCasaScambiatoreInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_ModelloCasaScambiatore(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_ModelloCasaScambiatoreInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_ModelloCasaScambiatore_optimization_info();
    }

    finalize_c2_ModelloCasaScambiatore
      ((SFc2_ModelloCasaScambiatoreInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_ModelloCasaScambiatore
    ((SFc2_ModelloCasaScambiatoreInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_ModelloCasaScambiatore(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_ModelloCasaScambiatore
      ((SFc2_ModelloCasaScambiatoreInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_ModelloCasaScambiatore(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_ModelloCasaScambiatore_optimization_info();
  ...
  ssSetChecksum0(S,(1443948862U));
  ssSetChecksum1(S,(1118078831U));
  ssSetChecksum2(S,(1419011631U));
  ssSetChecksum3(S,(3325415487U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_ModelloCasaScambiatore(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_ModelloCasaScambiatore(SimStruct *S)
{
  SFc2_ModelloCasaScambiatoreInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_ModelloCasaScambiatoreInstanceStruct *)utMalloc(sizeof
    (SFc2_ModelloCasaScambiatoreInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_ModelloCasaScambiatoreInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_ModelloCasaScambiatore;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_ModelloCasaScambiatore;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_ModelloCasaScambiatore;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_ModelloCasaScambiatore;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_ModelloCasaScambiatore;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_ModelloCasaScambiatore;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_ModelloCasaScambiatore;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_ModelloCasaScambiatore;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_ModelloCasaScambiatore;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_ModelloCasaScambiatore;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_ModelloCasaScambiatore;
...
void c2_ModelloCasaScambiatore_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_ModelloCasaScambiatore(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_ModelloCasaScambiatore(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_ModelloCasaScambiatore(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_ModelloCasaScambiatore_method_dispatcher.\n"
